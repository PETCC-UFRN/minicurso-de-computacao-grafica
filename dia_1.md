...
Nesse dia introdutório, buscaremos entender as bases da Computação Gráfica 2D, visando compreender como se dá o funcionamento de um desenho feito na tela, em especial, como criamos a ferramenta mais básica para o desenho, o canva, ou a tela em branco na qual iremos desenhar. Também sera grande foco do dia como que desenharemos nessa tela, entendendo como poderemos abstrair o conceito de cor para o computador.

<!-- FOTO DE UM QUADRO EM BRANCO -->
<img src="./assets/dia_1/white_canvas.jpg" alt="Tela branca" width="400" style="display: block; margin: 0 auto">


Em conjunto com a parte teórica, iremos implementar ao longo do dia um projeto que  servirá como uma introdução aos conceitos mais fundamentais que utilizaremos ao longo dos próximos dias. Antes de nos dedicarmos a desenhar algo na tela, escolher sua cor ou sua posição, precisamos entender como tudo isso se encaixa e como que a partir de linhas de código, conseguimos abstrair todos esses conceitos que parecem naturais para nós, como cor, formato e posição.

<!--FOTO DE CÓDIGO C++-->
<img src="./assets/dia_1/coding.jpg" alt="Tela com código" width="400" style="display: block; margin: 0 auto">

## Abstraindo Tinta e Tela

Antes de começarmos a abstrair, precisamos entender o que estamos abstraindo, e a maneira mais didática que podemos pensar sobre o desenho 2D no computador é a pintura no mundo real com tintas em uma tela branca.

Na vida real temos uma tela, que podemos chamar de Canvas, que servirá como base para que possamos o colorir com tinta. Essa tela, porém, não é transparente, então ele possui uma cor base, geralmente Branco!

Uma tela, ou quadro branco, é um objeto no mundo real que possui uma superficie **continua**, então não existe um "limite máximo" de Zoom que podemos dar nele até que possamos vizualizar qual cor está em cada partezinha pequena do quadro. A abstração que precisamos fazer é, então, transformar a superficie dessa tela em algo **discreto**, transformando-a em uma matriz finita, onde cada posição dessa matriz vai nos dizer qual é a cor da tela naquela posição.

<img src="./assets/dia_1/canvas_zoomed.png" alt="Canvas abstraido" width="400" style="display: block; margin: 0 auto">
...
<img src="./assets/dia_1/visible_spectrum.jpg" alt="Canvas abstraido" width="400" style="display: block; margin: 0 auto">

Novamente encontramos um problema parecido, temos um valor continuo, a frequência de um feixe de fótons, que deve ser tratado por uma máquina discreta. A maneira de fazer isso surge então com o modelo RGB (Red, Green and Blue), que busca definir cores com base na quantidade de vermelho, verde e azul. Embora o espectro RGB não seja capaz de nos forneces todas as cores disponíveis no espectro de luz visivel, é o suficiente para uma experiência realista de visualização de imagens em telas e monitores.

<!-- Comparação do espectro visível com o espectro RGB-->

<img src="./assets/dia_1/rgb_vs_visible_light.png" alt="Canvas abstraido" width="400" style="display: block; margin: 0 auto">

Agora que entendemos o que queremos abstrair e temos uma ideia básica de como fazer isso, podemos finalmente partir para as implementações!

<!-- foto de "mão na massa" -->

<img src="./assets/dia_1/lets_code.jpg" alt="Canvas abstraido" width="400" style="display: block; margin: 0 auto">

## Projeto Base para as Implementações
...
<img  src="./assets/dia_1/example_ppm.png"  alt="Imagem-PPM"  style="display: block; max-width: 40%; margin: 0 auto; border-radius: 8px;"  />

<p  style="margin: 0.5rem auto 0; text-align: center;"><em>Imagem descrita pelo arquivo PPM<br  /></em></p>
